...
#macro ITEM_MACHINEGUN ItemEquipFirearmAuto("Machine Gun", noone, spr_iconPistol, 100, "A powerful machine gun.", spr_equipAssaultRifle, game_get_speed(gamespeed_fps)/5, obj_bullet, 8, true)
#endregion
